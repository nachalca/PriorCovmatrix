...
namespace model_SS_lkj_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_SS_lkj");
    reader.add_event(23, 23, "end", "model_SS_lkj");
    return reader;
}

#include <meta_header.hpp>
 class model_SS_lkj : public prob_grad {
private:
    int k;
    double eta;
    double sigma_mu;
    ...
    int prior_sigma;
public:
    model_SS_lkj(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_SS_lkj_namespace::model_SS_lkj";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("Omega", "k", k);
        validate_non_negative_index("Omega", "k", k);
        context__.validate_dims("initialization", "Omega", "matrix_d", context__.to_vec(k,k));
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                Omega = in__.corr_matrix_constrain(k,lp__);
            else
                Omega = in__.corr_matrix_constrain(k);
            ...
            lp_accum__.add(lkj_corr_log<propto__>(Omega, eta));
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_SS_lkj_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        matrix_d Omega = in__.corr_matrix_constrain(k);
...
typedef model_SS_lkj_namespace::model_SS_lkj stan_model;
